...
[Report in HTML Format](https://www.codemr.co.uk/case-reports/kafka/html_report_streams_main/htmlx/lbd/dashboard.html)
...
(low → high)  ![metric-legend](codemr/snapshots-common/metric-legend.png)
...
In graphs, nodes represents software entities (class, methods) and edges represents the dependencies between the entities.
 ...
 ![node-colors](codemr/snapshots-common/node-colors.png)
Node color represents the complexity

 ![node-shape](codemr/snapshots-common/node-shape.png)
Node shape represents the coupling:

 ![node-size](codemr/snapshots-common/node-size.png)
...
![relations](codemr/snapshots-common/dependency-relation-rendering.png)
#  Supported Metrics
